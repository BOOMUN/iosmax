...
`;
  ...
  function Runtime() {
    ...
    function ObjCObject(handle2, protocol, cachedIsClass, superSpecifier2) {
      ...
      function stealTypesFromProtocols(klass, fullName) {
        const candidates2 = Object.keys(klass.$protocols).map((protocolName) => flatProtocolMethods({}, klass.$protocols[protocolName])).reduce((allMethods, methods) => {
          Object.assign(allMethods, methods);
          return allMethods;
        }, {});
        const method2 = candidates2[fullName];
        if (method2 === void 0) {
          return null;
        }
  ...
  // count_camera_pipeline_agent.js
  var candidates = [
  ...
  var counts = {};
  var listeners = [];
  candidates.forEach(([className, selector2]) => {
    const klass = frida_objc_bridge_default.classes[className];
    const method2 = klass ? klass[selector2] : null;
  ...
  var callers = {};
  var getterCalls = 0;
  var getter = Module.getGlobalExportByName("CMSampleBufferGetImageBuffer");

...
`;
  ...
  // inspect_mrc_route_agent.js
  function safe(label, callback) {
    try {
      const value = callback();
      if (value === null || value === void 0) return { label, value: "null" };
  ...
  var rows = frida_objc_bridge_default.chooseSync(frida_objc_bridge_default.classes.BWMRCNode).map((node) => {

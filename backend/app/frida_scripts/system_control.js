...
`;
  ...
  // system_control_agent.js
  function screenState() {
    const controller = frida_objc_bridge_default.classes.SBBacklightController.sharedInstance();
    const lockManager = frida_objc_bridge_default.classes.SBLockScreenManager.sharedInstance();
    return {
  ...
  rpc.exports = {
    async wake() {
      await frida_objc_bridge_default.schedule(frida_objc_bridge_default.mainQueue, () => {
        const controller = frida_objc_bridge_default.classes.SBBacklightController.sharedInstance();

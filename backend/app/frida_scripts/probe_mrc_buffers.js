...
`;
  ...
  // probe_mrc_buffers_agent.js
  function globalExport(name) {
    return Module.getGlobalExportByName(name);
  }
  var getImageBuffer = new NativeFunction(globalExport("CMSampleBufferGetImageBuffer"), "pointer", ["pointer"]);
  var getWidth = new NativeFunction(globalExport("CVPixelBufferGetWidth"), "ulong", ["pointer"]);
  var getHeight = new NativeFunction(globalExport("CVPixelBufferGetHeight"), "ulong", ["pointer"]);
  var getPixelFormat = new NativeFunction(globalExport("CVPixelBufferGetPixelFormatType"), "uint", ["pointer"]);
